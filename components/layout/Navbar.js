        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              <div
                className="rounded-xl flex items-center justify-center transition-colors shadow-glow-sm"
              >
                <Image
                  src="/logo.png"
                  alt="Logo"
              ...
              <span className="font-heading font-bold text-xl tracking-wide">
                ...
                <span className="text-steel-900 dark:text-steel-100">
                  {" "}
                  SPARE
                </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/wishlist"
                className="relative p-2.5 rounded-xl hover:bg-steel-100 dark:hover:bg-steel-800 text-steel-600 dark:text-steel-400 hover:text-brand-500 transition-colors"
              >
                <HiHeart size={20} />
                {wishlistCount > 0 && (
          ...
          >
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between px-4 h-16 border-b border-steel-200 dark:border-steel-800">
                <span className="font-heading font-bold text-lg text-brand-500">
                  MENU
                </span>
                <button onClick={() => setMobileOpen(false)} className="p-2">
                  <HiX
                    size={24}
                    className="text-steel-600 dark:text-steel-400"
                  />
                </button>
              </div>
              ...
              <nav className="flex-1 overflow-y-auto px-4 py-6 space-y-1">
                ...
                {isAdmin && (
                  <Link
                    href="/admin"
                    className="block px-4 py-3 rounded-xl font-heading font-semibold text-lg text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all"
                  >
                    Admin Dashboard
                  </Link>
                )}
